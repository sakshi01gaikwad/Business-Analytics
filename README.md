...
|----------|--------------|----------------|
| [**FSS App – Group Feature Improvement**](Project 1: App Feature Improvement) | Converted stakeholder video feedback into a structured Agile backlog using Jira. Created user stories, grouped them under Epics, and set up a sprint for tracking. | Jira · Scrum · Requirements Analysis |
